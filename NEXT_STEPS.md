# Next Steps — GI-Utils v1.1.1

## 当前状态

v1.1.1 — 10 个功能通过 TOML 配置驱动注册。master 48/48 review 全清；gi-utils-gui 分支 2H/12M/15L 全清（含 L12 核心分离）；时间轴调度器 15/15 全清（2026-08-14）；GUI 崩溃自愈两轮 review 全清 + 睡眠唤醒实测通过（2026-08-15）。
