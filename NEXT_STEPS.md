...
v1.1.0 — 10 个功能通过 TOML 配置驱动注册。master 48/48 review 全清；gi-utils-gui 分支 2H/12M/15L 全清（含 L12 核心分离）；时间轴调度器 15/15 全清（2026-08-14）。
...
|--------|------|------|------|
| 1 | 甘雨加特林 | ★★ | R+鼠标移动序列 |
| 2 | 龙王喷水 | ★★ | 共享 mutable mouse stroke，方向键子功能（Arc<Mutex> 共享状态设计已定，代码暂缓并入 stable） |
| 3 | 克洛琳德 | ★★★ | 像素颜色检测触发 |
| 4 | 添加好友 | ★★★ | 屏幕坐标+绝对鼠标 |
| 5 | 申请加入 | ★★ | 鼠标序列 |
| 6 | 2048 系列 | ★ | 纯按键序列 |
