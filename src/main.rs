//! GI-Utils: Keystroke Monitor (verbose mode).
//!
//! Intercepts and displays all keyboard events with device info.
//! Press F12 to exit.
...
fn main() {
    ...
    println!("  GI-Utils v0.1.0  --  Keystroke Monitor");
    println!("\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}\u{2550}");
    println!();
    println!("  \u{2193} press  \u{2191} release    KBD = keyboard  MSE = mouse");
    println!("  E0 = extended key    E1 = pause-break prefix");
    println!("  F12 = exit");
    println!();
    ...
    let monitor = KeyMonitor::verbose();
    monitor.run();
}
